...
/**
 * Footer Component
 * Single Responsibility: Display footer with copyright and social links
 */
function Footer({ data }) {
    const currentYear = new Date().getFullYear();
    const { name, github, linkedin, stackoverflow } = data.personal_details;
            ...
            <div className="container">
                <div className="footer__content">
                    ...
                    <div className="footer__socials">
                        ...
                        <a href={stackoverflow} target="_blank" rel="noopener noreferrer" aria-label="Stack Overflow">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
